...
local Default = {
        Box = {
        Properties = {On = true, Type = 'Quad', Mode = '2D Corner', Color = Color3.fromRGB(255, 255, 255), CornerTransparency = 0, Transparency = 0.65, Visible = true},
    ...
    Chams = {
        Properties = {On = true, Material = "Neon", Breath = true, Visible = true, Color = {Fill = Color3.fromRGB(204, 46, 107), Outline = Color3.fromRGB(204, 46, 107)}, Transparency = {Fill = 100, Outline = 100}}
    },
        Trail = {
        Properties = {
            On = true,
...
local watermark = create_watermark("alex541.cc", _index, nil)
